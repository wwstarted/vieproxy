(function ($) {
  ...
  $(window).on("load", function () {
    const $wrapper = $(".single-product-related-slider-wrapper");
    const $slider = $(".single-product-related-slider");
    const $cards = $slider.find(".pricing-card");
    const $prevBtn = $(".single-product-related-slider__arrow--prev");
    const $nextBtn = $(".single-product-related-slider__arrow--next");
    const $dotsContainer = $(".single-product-related-slider__dots");
    ...
    function generateDots() {
      ...
      for (let i = 0; i < total; i++) {
        const $dot = $(
          '<div class="single-product-related-slider__dot"></div>',
        );
        if (i === 0) $dot.addClass("is-active");
        $dotsContainer.append($dot);
      }

      $dots = $(".single-product-related-slider__dot");

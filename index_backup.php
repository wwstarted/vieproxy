                    ...
                    <div class="home-hero-order-widget">
                        <div class="home-hero-order-bar">
                            ...
                            <div class="home-hero-order-field has-dropdown">
                                ...
                                <div class="home-order-field__select" tabindex="0" role="button" aria-haspopup="listbox" aria-expanded="false">
                            ...
                            <div class="home-hero-order-field has-dropdown">
                                ...
                                <div class="home-order-field__select" tabindex="0" role="button" aria-haspopup="listbox" aria-expanded="false">
                                    <img src="<?php echo get_template_directory_uri(); ?>/images/vietnam.png" alt="Vietnam" class="home-order-flag" />
                                    <span class="home-order-field__value">Việt Nam</span>
                                    <i class="fa-solid fa-chevron-down home-order-chevron"></i>
                                </div>
                                <ul class="home-order-dropdown" role="listbox">
                                    <li class="home-order-dropdown__item is-selected" role="option">
                                        <img src="<?php echo get_template_directory_uri(); ?>/images/vietnam.png" alt="" class="home-order-flag" />
                                        Việt Nam
                                    </li>
                                    <li class="home-order-dropdown__item" role="option">
                                        <img src="<?php echo get_template_directory_uri(); ?>/images/united-kingdom.png" alt="" class="home-order-flag" />
                                        United Kingdom
                                    </li>
                                    <li class="home-order-dropdown__item" role="option">
